...
img=pygame.image.load('action/games/Hangman/hangman.jpg')
icon=pygame.image.load('action\games\Hangman\icon.png')
pygame.display.set_icon(icon)
win_sound=pygame.mixer.Sound('action/games/Hangman/win.wav')
loss_sound=pygame.mixer.Sound('action/games/Hangman/loss.wav')
click_sound=pygame.mixer.Sound('action/games/Hangman/click.wav')
pygame.mixer.music.load('action/games/Hangman/music.mp3')
fileptr=open('action/games/Hangman/wordlist','r')
words=fileptr.read()
words=words.split('\n')

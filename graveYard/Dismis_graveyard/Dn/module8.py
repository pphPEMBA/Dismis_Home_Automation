...
if __name__ == "__main__": 
    sendSMS() 
For execution of script, edit the number, app_key and app_secret fields and then simply run the script.

I have written complete script for sending SMS updates to mobile phone using sinchSMS and way2sms by fetcing latest updates from our placement website(aitplacements.com). GitHub link : stayUpdated

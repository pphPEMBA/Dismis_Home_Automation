...
driver = webdriver.Chrome(executable_path=r"C:\Visual Studio Project\Dismis\Dismis\SystemHandleCore\webdriver\chromedriver.exe")

#driver = {'user-agent': 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36'}
